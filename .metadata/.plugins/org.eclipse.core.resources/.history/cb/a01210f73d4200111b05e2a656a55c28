...
public class CALCULADORA extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == Eliminar) {
			do_btnNewButton_10_actionPerformed(e);
		}
		if (e.getSource() == btnNewButton_14) {
			do_btnNewButton_14_actionPerformed(e);
		}
		if (e.getSource() == btnNewButton_13) {
			do_btnNewButton_13_actionPerformed(e);
		}
		if (e.getSource() == mas) {
			do_mas_actionPerformed(e);
		}
		if (e.getSource() == cero) {
			do_cero_actionPerformed(e);
		}
		if (e.getSource() == btnNewButton_15) {
			do_btnNewButton_15_actionPerformed(e);
		}
		if (e.getSource() == resta) {
			do_resta_actionPerformed(e);
		}
		if (e.getSource() == nueve) {
			do_nueve_actionPerformed(e);
		}
		if (e.getSource() == ocho) {
			do_ocho_actionPerformed(e);
		}
		if (e.getSource() == siete) {
			do_siete_actionPerformed(e);
		}
		if (e.getSource() == seis) {
			do_seis_actionPerformed(e);
		}
		if (e.getSource() == cinco) {
			do_cinco_actionPerformed(e);
		}
		if (e.getSource() == cuatro) {
			do_cuatro_actionPerformed(e);
		}
		if (e.getSource() == tres) {
			do_tres_actionPerformed(e);
		}
		if (e.getSource() == dos) {
	...
	protected void do_tres_actionPerformed(ActionEvent e) {
		
		txtPantalla.setText(txtPantalla.getText()+3);
	}
	protected void do_cuatro_actionPerformed(ActionEvent e) {
		
		txtPantalla.setText(txtPantalla.getText()+4);
	}
	protected void do_cinco_actionPerformed(ActionEvent e) {
		
		txtPantalla.setText(txtPantalla.getText()+5);
	}
	protected void do_seis_actionPerformed(ActionEvent e) {
		
		txtPantalla.setText(txtPantalla.getText()+6);
	}
	protected void do_siete_actionPerformed(ActionEvent e) {
		
		txtPantalla.setText(txtPantalla.getText()+7);
	}
	protected void do_ocho_actionPerformed(ActionEvent e) {
	...
	protected void do_borrartd_actionPerformed(ActionEvent e) {
		txtOperacion.setText("");
		txtPantalla.setText("");
	}
	}
